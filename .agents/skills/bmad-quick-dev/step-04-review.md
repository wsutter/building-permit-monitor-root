...
### Git Flow: Squash-Merge Preparation
1. Ensure all changes are committed and pushed to the feature branch.
2. If the review is approved, proceed to squash-merge in `step-05-present.md`.
...
2. **Commit Review Feedback**
   - After addressing feedback, commit changes with the message:
     ```
     Review: {story-key} - Address feedback for {brief-description}
     ```
     Example:
     ```
     Review: 1-1-csv-mapping - Address feedback for field validation
     ```
